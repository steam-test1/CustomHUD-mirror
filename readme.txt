...
* Plugin_Downs tracks number of lives the player and human team mates have (for the team, it assumes no nine lives skill but takes it into account for the player). ("lib/units/beings/player/huskplayermovement" and "lib/network/handlers/unitnetworkhandler")